...
import { BookOpen, Sparkles, LogOut, ShieldCheck, User, PanelLeft, Menu } from 'lucide-react';
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-stone-400 truncate hidden lg:block">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              {user.photoURL && !avatarError ? (
                ...
                <div className="hidden lg:block text-left text-xs">
                  <div className="font-medium text-stone-200 truncate max-w-[130px]">
